...
"}")
        ...
        self.solarGenScenPercDsb.setMinimumSize(QSize(70, 0))
        self.solarGenScenPercDsb.setMaximumSize(QSize(16777215, 16777215))
        self.solarGenScenPercDsb.setFont(font1)
        self.solarGenScenPercDsb.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.solarGenScenPercDsb.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.solarGenScenPercDsb.setMaximum(100.000000000000000)
...
"")
        ...
        self.toprodHiH2ResLbl.setFont(font9)
        ...
        self.maxHiH2ResLbl.setFont(font9)
...
"")
        ...
        self.co2EmisRedResPerspDsb.setMinimum(-999999999.990000009536743)
