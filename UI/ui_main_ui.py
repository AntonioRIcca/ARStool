...
"}")
        ...
        self.leftMenuContainer.setMinimumSize(QSize(170, 0))
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/icons/reliability.png", QSize(), QIcon.Normal, QIcon.Off)
        self.reliability_Btn.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/icons/adequacy.png", QSize(), QIcon.Normal, QIcon.Off)
        self.adequacy_Btn.setIcon(icon9)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/icons/opf.png", QSize(), QIcon.Normal, QIcon.Off)
        self.opf_Btn.setIcon(icon11)
...
#if QT_CONFIG(tooltip)
        self.dataBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Mostra dettagli di rete", None))
#endif // QT_CONFIG(tooltip)
        self.dataBtn.setText(QCoreApplication.translate("MainWindow", u"Dettagli", None))
#if QT_CONFIG(tooltip)
        self.reportBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Stampa Report", None))
#endif // QT_CONFIG(tooltip)
        self.reportBtn.setText(QCoreApplication.translate("MainWindow", u"Report", None))
#if QT_CONFIG(tooltip)
        self.loadProfilesBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Carica profili standard", None))
#endif // QT_CONFIG(tooltip)
        self.loadProfilesBtn.setText(QCoreApplication.translate("MainWindow", u"Prodili Standard", None))
#if QT_CONFIG(tooltip)
        self.restartBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Reset delle reti", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.anom_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"Generazione di Anomalie", None))
#endif // QT_CONFIG(tooltip)
        self.anom_Btn.setText(QCoreApplication.translate("MainWindow", u"Anomalie", None))
#if QT_CONFIG(tooltip)
        self.reliability_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"Calcolo dell'Affdabilit\u00e0", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.opf_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"Operational Planning", None))
#endif // QT_CONFIG(tooltip)
        self.opf_Btn.setText(QCoreApplication.translate("MainWindow", u"Operational Planning", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.settingsBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Impostazioni", None))
#endif // QT_CONFIG(tooltip)
        self.settingsBtn.setText(QCoreApplication.translate("MainWindow", u"Impostazioni", None))
#if QT_CONFIG(tooltip)
        self.infoBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Informazioni", None))
#endif // QT_CONFIG(tooltip)
