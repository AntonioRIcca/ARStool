...
################################################################################
## Form generated from reading UI file 'main_uiMmEmOF.ui'
##
...
"}")
        ...
        self.lf_Btn = QPushButton(self.frame_11)
        self.lf_Btn.setObjectName(u"lf_Btn")
        self.lf_Btn.setMinimumSize(QSize(0, 40))
        self.lf_Btn.setMaximumSize(QSize(16777215, 40))
        self.lf_Btn.setFont(font)
        self.lf_Btn.setStyleSheet(u"")
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/loadflow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.lf_Btn.setIcon(icon4)
        self.lf_Btn.setIconSize(QSize(24, 24))
        self.lf_Btn.setFlat(False)

        self.verticalLayout_16.addWidget(self.lf_Btn)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/anomaly.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/opf.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.rel_Btn = QPushButton(self.frame_11)
        self.rel_Btn.setObjectName(u"rel_Btn")
        self.rel_Btn.setMinimumSize(QSize(0, 40))
        self.rel_Btn.setMaximumSize(QSize(16777215, 40))
        self.rel_Btn.setFont(font)
        self.rel_Btn.setStyleSheet(u"")
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/reliability.png", QSize(), QIcon.Normal, QIcon.Off)
        self.rel_Btn.setIcon(icon7)
        self.rel_Btn.setIconSize(QSize(24, 24))
        self.rel_Btn.setFlat(False)

        self.verticalLayout_16.addWidget(self.rel_Btn)

        self.gm_Btn = QPushButton(self.frame_11)
        self.gm_Btn.setObjectName(u"gm_Btn")
        self.gm_Btn.setMinimumSize(QSize(0, 40))
        self.gm_Btn.setMaximumSize(QSize(16777215, 40))
        self.gm_Btn.setFont(font)
        self.gm_Btn.setStyleSheet(u"")
        icon8 = QIcon()
        icon8.addFile(u":/icons/icons/gridmanagement.png", QSize(), QIcon.Normal, QIcon.Off)
        self.gm_Btn.setIcon(icon8)
        self.gm_Btn.setIconSize(QSize(24, 24))
        self.gm_Btn.setFlat(False)

        self.verticalLayout_16.addWidget(self.gm_Btn)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/icons/onr.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/icons/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/icons/info.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/icons/help.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.restartBtn = QPushButton(self.frame_3)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/icons/restart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.restartBtn.setIcon(icon13)
        self.restartBtn.setIconSize(QSize(24, 24))
        self.restartBtn.setFlat(False)

        self.verticalLayout_4.addWidget(self.restartBtn)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/icons/close.png", QSize(), QIcon.Normal, QIcon.Off)
        self.closeCenterMenuBtn.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/icons/notifications.png", QSize(), QIcon.Normal, QIcon.Off)
        self.notificationBtn.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/icons/dots.png", QSize(), QIcon.Normal, QIcon.Off)
        self.moreMenuBtn.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/icons/icons/user.png", QSize(), QIcon.Normal, QIcon.Off)
        self.profileMenuBtn.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/icons/icons/minimize.png", QSize(), QIcon.Normal, QIcon.Off)
        self.minimizeBtn.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/icons/icons/maximize.png", QSize(), QIcon.Normal, QIcon.Off)
        self.restoreBtn.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/icons/close2.png", QSize(), QIcon.Normal, QIcon.Off)
        self.closeBtn.setIcon(icon20)
        ...
        self.closeRightMenuBtn.setIcon(icon14)
...
#if QT_CONFIG(tooltip)
        self.lf_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"LoadFlow", None))
#endif // QT_CONFIG(tooltip)
        self.lf_Btn.setText(QCoreApplication.translate("MainWindow", u"LoadFlow", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.rel_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"Reliability and Adequacy", None))
#endif // QT_CONFIG(tooltip)
        self.rel_Btn.setText(QCoreApplication.translate("MainWindow", u"Reliability", None))
#if QT_CONFIG(tooltip)
        self.gm_Btn.setToolTip(QCoreApplication.translate("MainWindow", u"Grid Management", None))
#endif // QT_CONFIG(tooltip)
        self.gm_Btn.setText(QCoreApplication.translate("MainWindow", u"Grid Management", None))
#if QT_CONFIG(tooltip)
