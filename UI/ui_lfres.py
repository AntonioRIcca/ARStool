...
################################################################################
## Form generated from reading UI file 'lfresJSYewp.ui'
##
...
"color: rgb(255, 255, 127);")
    ...
    def retranslateUi(self, lfres_mainWGT):
        ...
        self.extgrid_GB.setTitle(QCoreApplication.translate("lfres_mainWGT", u"Rete esterna", None))
        self.q_eg_value_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"2000.00", None))
        self.q_eg_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Passiva", None))
        ...
        self.p_eg_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Attiva", None))
        self.loads_GB.setTitle(QCoreApplication.translate("lfres_mainWGT", u"Carichi", None))
        self.p_loads_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Attiva", None))
        self.p_loads_value_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"1258.25", None))
        self.q_loads_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Passiva", None))
        ...
        self.p_bess_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Attiva", None))
        self.p_bess_value_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"1258.25", None))
        self.q_bess_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Passiva", None))
        ...
        self.gen_GB.setTitle(QCoreApplication.translate("lfres_mainWGT", u"Generatori", None))
        self.p_gen_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Attiva", None))
        self.q_gen_unit_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"kVar", None))
        self.q_gen_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Passiva", None))
        ...
        self.loss_GB.setTitle(QCoreApplication.translate("lfres_mainWGT", u"Perdite di rete", None))
        self.p_loss_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Attiva", None))
        ...
        self.q_loss_lbl_LBL.setText(QCoreApplication.translate("lfres_mainWGT", u"Potenza Passiva", None))
