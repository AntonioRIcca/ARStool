...
filename = 'test_dss.dss'
dss.text(f"compile [{path + '/' + filename}]")
# self.dss.text(f"Save Circuit dir=cartella")     # scrittura della cartella degli elementi

dss.monitors.name = 'MP_Load1'
print(dss.meters.metered_element)
for i in [1, 3, 5]:
...
# # - il nome dell'elemento (in D)SS è la parte dopo il punto e.g. "WPG_TR")
# for item in dss.circuit.elements_names:
#     [tag, el] = item.split('.')
#     if tag == 'Vsource':
#         cat = 'ExternalGrid'
#     else:
